...
# After having installed Anaconda you have set of programming editors and IDEs (e.g. Jupyter Notebook, JupytherLab, Spyder, PyCharm, etc.) at hand. For a nice overview and comparsion of such Python IDEs and code editors see e.g. [Comparision of Python IDEs] 
