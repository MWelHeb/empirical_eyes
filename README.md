...
# Apart from the (data science) question you obviously have to have some relevant data at hand as well access to a data science software that provides the required functionalities you need in order to collect, modify/manipulate and finally analyse and display the data and results.
