...
# After having installed Anaconda you have set of programming editors and IDEs (Jupyter Notebook, JupytherLab, Spyder, PyCharm, etc.).    Which development environment/programming editor to use ? 
