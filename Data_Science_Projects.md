...
In the following I will describe the various steps of the data analysis I have conducted including the corresponding python script. If you would like to have see the full final python script please look here:
